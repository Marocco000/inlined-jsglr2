...
// @formatter:on
    ...
    @Override public ParseState getParseState(JSGLR2Request request, String previousInput,
        IncrementalParseForest previousResult) {
    ...
    @Override public void actor(StackNode stack, ParseState parseState) {
    ...
    @Override public IncrementalParseForest getNodeToShift(ParseState parseState) {
